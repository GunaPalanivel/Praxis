...
- The implementation clamps per-step rewards to `[0.0, 1.0]`.
- Wrong or premature actions receive no credit (`0.00`).
- Duplicate actions are penalized (-50%).
- Medium and Hard tasks apply a per-step cost (0.005 and 0.003) to discourage aimless exploration.
...
| Wrong diagnosis                                 | `0.00`  |
| Wrong remediation                               | `0.00`  |
...
| Wrong diagnosis                                            | `0.00`  |
| Wrong remediation or premature escalation                  | `0.00`  |
...
| Premature diagnosis                                             | `0.00`  |
| Premature escalation                                            | `0.00`  |
