...
- The implementation clamps per-step rewards to `[0.01, 0.99]`.
- Wrong or premature actions receive near-zero credit (`0.01`) after penalties.
...
| Wrong diagnosis                                            | `0.01`   |
| Wrong remediation or premature escalation                  | `0.01`   |
...
| Premature diagnosis                                             | `0.01`   |
| Premature escalation                                            | `0.01`   |
