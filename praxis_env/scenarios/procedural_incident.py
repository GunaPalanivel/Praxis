...
class ProceduralIncidentScenario(BaseScenario):
    ...
    DIFFICULTY_CONFIG = {
        "easy": {"n_services": 1, "n_red_herrings": 0, "max_steps": 15, "memory_cutoff": 8},
        "medium": {
            "n_services": 3,
            "n_red_herrings": 2,
            "max_steps": 25,
        ...
        "hard": {"n_services": 5, "n_red_herrings": 4, "max_steps": 50, "memory_cutoff": 25},
    }

    REMEDIATION_BY_ROOT_CAUSE: dict[str, tuple[str, str]] = {
        "db_connection": ("restart_service", "database"),
        "auth_token": ("rollback_deploy", "auth"),
    ...
    def _build_procedural_policy(self, difficulty: str) -> RewardPolicy:
        ...
        event_values = {
            ...
            "investigation.check_metrics.default": 0.04 if difficulty == "easy" else 0.02,
            ...
            "investigation.check_config.default": 0.03 if difficulty == "easy" else 0.02,
            "investigation.check_runbook.default": 0.04 if difficulty == "easy" else 0.025,
    ...
    def _reset_scenario_state(self) -> None:
        ...
        remediation_action, remediation_service = self.REMEDIATION_BY_ROOT_CAUSE[
        ...
        self._correct_remediation_event = (
            f"remediation.{remediation_action}.{remediation_service}"
        )
